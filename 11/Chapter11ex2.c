// Example program #2 from Chapter 11 of Absolute Beginner's Guide to C, 3rd Edition
// File Chapter11ex2.c

/* This program asks the user for their birth year and calculates how they wil lbe in the current year.
