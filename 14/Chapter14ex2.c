// Example program #2 from Chpater 14 of Absolute Beginner's Guide to C, 3rd Edition
// File Chapter14ex2.c
...
main()
{
    ...
    do {
        ...
        // If the user enter a lowercase n, this if statement will convert it to an N
        if (choice == 'n')
            {
                choice = 'N';
            }
