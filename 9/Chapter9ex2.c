...
/* This program asks the user tfor a number of tires and price per tire. 
...
main()
{
    // Variables for the number of tires purchased, price before a tax total, and a total cost with tax.
