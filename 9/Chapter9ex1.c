// Example program #1 from Chapter 9 of Absolute Beginner's Guide to C, 3rd Edition
// File Chapter9ex1.c

/* This is a sample program that demostrates math operators, and the different types of division */

#include <stdio.h>

main()
{
    // Two set of equivalent variables, with one set floating-point and the other integer
    ...
    printf("%d modulus (ie. remainder of) %d equals %d\n", x, y, intAnswer);
