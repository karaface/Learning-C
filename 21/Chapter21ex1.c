// Example program #1 from Chapter 21 of Absolute Beginner's Guide to C, 3rd Edition
// File Chapter21ex1.c
...
int main()
{
    ...
    for (i = 6; i < 10; i++)
    {
        printf("What did the player score in the game %d?", i+1); // Add one to the array number as the user won't think of the first game as 0
    ...
    // Use a floating-point variable for the average as it is likely to be betwen two integers
