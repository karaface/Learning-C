// Example program #2 from Chapter 27 of Absolute Beginner's Guide to C, 3rd Edition
// File Chapter27ex2.c
...
int main ()
{
    ...
    int ctr;
    struct bookInfo *books[3]; // Array of threee structure variables

    // Get information about each book from user
    ...
    for (ctr = 0; ctr < 3; ctr++)
    {
        ...
        getchar(); // Clears newline input to keep things clean for the next round
    }
