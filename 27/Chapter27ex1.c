// Example program #1 from Chapter 27 of Absolute Beginner's Guide to C, 3rd Edition
// File Chapter27ex1.c

/* The program gets the bookInfo structure by including bookinfo.h and asks the user to fill in three structures and then prints them. */
