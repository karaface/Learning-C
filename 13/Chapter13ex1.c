// Example program #1 from Chapter 13 of Absolute Beginner's Guide to C, 3rd Edition
// File Chapter13ex1.c

/* This program asks for a number from 1 to 100 and tells then wether or not their choice is equally divisible by 2 through 9. */
...
main()
{
    ...
    // printf("\n%d %s divisible by 10.", numPick, (numPick % 10 == 0) ? ("is") : ("is not"));
