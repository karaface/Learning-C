// Example program #1 from Chapter 25 of Absolute Beginner's Guide to C, 3rd Edition
// File Chapter25ex1.c

/* This program declare and initializes an array of character pointers and then asks for ratings associated */
...
int main()
{
    ...
    char *movies[9] = {"Amour", "Argo", "Beasts of the Southern Wild", "Django Unchained", "Les Miserables", "Life of Pi", "Lincoln", "Silver Linnings Playbook", "Zero Dark Thirty"};
    ...
    for (i = 0; i < 9; i++)
    {
        ...
        if ((toupper(ans)) == 'Y')
        {
            ...
            ctr++; // This will be used to print only movies seen
            continue;
        }
        else
        {
