// Example program #1 from Chapter 28 of Absolute Beginner's Guide to C, 3rd Edition
// File Chapter28ex1.c

/* The program takes the book info program from chapter 27 and writes the info to a file named bookinfo.txt */

// First include the file with structure definition

#include "../27/bookinfo.h"
#include <stdio.h>
#include <stdlib.h>
FILE * fptr;
