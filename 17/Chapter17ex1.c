// Example program #1 from Chapter 17 of Absolute Beginner's Guide to C, 3rd Edition
// File Chapter17ex1.c

/* This program prsents a menu of choices, gets the user's choice and then uses the switch statement to execute a line or two fo code based on that choice.
    ...
    do
    {
        ...
        switch(choice)
        {
            case(1): printf("\nTo add you will need the contact's\n");
                     ...
                     break;
            case(2): printf("\nPlease enter the name of the contact's name you wish to change.\n");
                     break;
