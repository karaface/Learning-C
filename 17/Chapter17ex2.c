// Example program #2 from Chapter 17 of Absolute Beginner's Guide to C, 3rd Edition
// File Chapter17ex2.c

/* This program presents a menu of choice (three different decades), and gets the user's choice, then presents a secondary menu (sports, entertainment and politics).
 * When the user makes her second choice, it prints a list of key information from that decade in that specific category. */
...
main()
{
    ...
    printf("What decade do you want to explore?\n");
    printf("1. The 1980s\n");
    printf("2. The 1990s\n");
    printf("3. The 2000s\n");
    printf("4. Quit\n");
    ...
    do 
    {
        ...
        switch(choice1)
        {
            // In the first case, the user picked the 1980s. Now it is time to see waht specific info they need.
            ...
            case(1):
            {
                ...
                {
                    printf("\n\nOscar-Winning Movies on the 1980s: \n");
                ...
                {
                    printf("\n\nUS Presidents of the 1980s:\n");
                    printf("1980: Jimmy Carter\n");
                    printf("1981-1988: Ronald Regan\n");
            ...
            case(2):
            {
                printf("\n\nWhat would information would you like to see?\n");
                printf("1. Baseball\n");
                printf("2. The Movies\n");
                printf("3. US Presidents\n");
                printf("4. Quit\n");
            ...
            case(3):
            {
                ...
                {
                    printf("\n\nOscar-Winning Movies of the 2000s:\n");
